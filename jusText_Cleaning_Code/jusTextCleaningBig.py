...
path = "/user/cs4984cs5984f18_team14/14_Facebook_Breach_big/articlehtmlbig.json"
...
#cleanDF.coalesce(1).write.format('json').save('/user/cs4984cs5984f18_team14/14_Facebook_Breach_big/cleaned_paragraphs') #Can't use coalesce here because the file is too big to be written sequentially
cleanDF.write.format('json').save('/user/cs4984cs5984f18_team14/14_Facebook_Breach_big/cleaned_paragraphs')