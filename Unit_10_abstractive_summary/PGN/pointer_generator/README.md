...
This code is based off of that written for the ACL 2017 paper *[Get To The Point: Summarization with Pointer-Generator Networks](https://arxiv.org/abs/1704.04368)*. For an intuitive overview of the paper, read the [blog post](http://www.abigailsee.com/2017/04/16/taming-rnns-for-better-summarization.html).
The current version of this code has been modified by Leah Hamilton to run in Python 3.6 and skip the pyrouge evaluation so that abstractive summaries can be generated without needing to have ROUGE installed.
To do this, use the decode instructions below. Other functionality has not been tested after porting to 3.6.
